...
namespace HotterThanLavaMod
{
	...
	public static class RefineryMercuryMod
	{
		...
		{
			ElementLoader.FindElementByHash(SimHashes.Wolframite).thermalConductivity = 0.000001f;
			ElementLoader.FindElementByHash(SimHashes.Wolframite).highTemp = 1000000f;
			ElementLoader.FindElementByHash(SimHashes.Tungsten).thermalConductivity = 0.000001f;
			ElementLoader.FindElementByHash(SimHashes.Tungsten).highTemp = 1000000f;
			ElementLoader.FindElementByHash(SimHashes.Mercury).lowTemp = 5f;
			ElementLoader.FindElementByHash(SimHashes.Mercury).highTemp = 400f;
			ComplexRecipe.RecipeElement recipeElement4 = new ComplexRecipe.RecipeElement(ElementLoader.FindElementByHash(SimHashes.Gold).tag, 50f);
			ComplexRecipe.RecipeElement recipeElement5 = new ComplexRecipe.RecipeElement(ElementLoader.FindElementByHash(SimHashes.Steel).tag, 50f);
			ComplexRecipe.RecipeElement recipeElement6 = new ComplexRecipe.RecipeElement(ElementLoader.FindElementByHash(SimHashes.Mercury).tag, 50f);

			ComplexRecipe.RecipeElement[] ingredients1 = new ComplexRecipe.RecipeElement[2] { recipeElement4, recipeElement5 };
